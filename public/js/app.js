...
sideMenuSubLinkCloseBtns.forEach((sideMenuSubLinkCloseBtn) => {
    sideMenuSubLinkCloseBtn.addEventListener("click", function (e) {
        e.stopPropagation();
        sideMenuSubLinkCloseBtn.parentElement.classList.remove(
            "opacity-100",
        );
        sideMenuSubLinkCloseBtn.parentElement.classList.add(
            "-z-10",
        );
        sideMenuSubLinkCloseBtn.parentElement.classList.remove(
            "p-5",
